...
Today I had two quick ideas for what to look for, either industrial control systems or minecraft servers. Flipping a coin, ICS won out. Reading a quick Shodan guide on them I decided to look for Siemens control systems, for no reason other than I'd heard of them before.

### Joann Fabric's Industrial Control System on 208.83.32.213

Siemens has a proprietary network protocol called [S7 Communications](https://wiki.wireshark.org/S7comm) that they use for their [Programmable Logic Controllers (PLC)](https://en.wikipedia.org/wiki/Programmable_logic_controller), which they also provide a nice [sales brochure for](https://www.automation.siemens.com/salesmaterial-as/brochure/en/brochure_simatic-controller_overview_en.pdf). It runs on port 102 so I did a search on Shodan for IPs using port 102.
Picking one of the first IPs I found that it belonged to Joann Fabric.
```
👻🌵✨$ host 208.83.32.213
213.32.83.208.in-addr.arpa domain name pointer i.joann.com
```
The IP was pointed to i.joann.com. I've frequently seen in store websites' code links to things like `abcde.store.com`, usually as links to their internal database for inventory or as internal content management systems. So my first hunch was that i.joann.com was a database used for their warehouse inventories that plugged into websites when making online orders ("i" sounds like a great name for an inventory service if you ask me). However I checked on [PublicWWW](https://publicwww.com) to see if there were any links to i.joann.com in _any_ websites and there were not. So it's not something that has to do with Joann's web presence. Then I used [nmap](https://nmap.org/) to see all the different ports that they were using to see if I could figure out what they were using this service for. Well as you can see at the bottom it looks like they just left a whole lot of commonly used ports open, except, oddly enough, the one that brought me there (102). Why? What am I actually looking at here?

Checking traceroute I thought would give me a clue.
```
traceroute to i.joann.com (208.83.32.213), 64 hops max, 52 byte packets
 1  192.168.0.1 (192.168.0.1)  1.125 ms  0.812 ms  0.853 ms
 2  * * *
 3  be61.nycynymy02h.nyc.rr.com (68.173.202.74)  14.527 ms  12.444 ms  36.330 ms
 4  agg113.nyquny9101r.nyc.rr.com (68.173.198.42)  18.494 ms  27.239 ms  20.124 ms
 5  bu-ether25.nycmny837aw-bcr00.tbone.rr.com (107.14.19.22)  21.960 ms
    bu-ether15.nycmny837aw-bcr00.tbone.rr.com (66.109.6.76)  17.162 ms  23.935 ms
 6  bu-ether12.chcgildt87w-bcr00.tbone.rr.com (66.109.6.25)  70.897 ms  66.850 ms
    so-0-0-0.ar1.cdp01.tbone.rr.com (66.109.6.95)  64.930 ms
 7  bu-ether24.chctilwc00w-bcr00.tbone.rr.com (66.109.9.40)  68.389 ms  66.568 ms  70.349 ms
 8  66.109.5.121 (66.109.5.121)  64.734 ms  67.480 ms  64.982 ms
 9  ix-ae-52-0.tcore2.dt8-dallas.as6453.net (66.110.57.162)  64.496 ms  55.399 ms  56.252 ms
10  sjp-brdr-06.inet.qwest.net (63.146.26.249)  59.788 ms  61.679 ms  67.690 ms
11  cle-edge-02.inet.qwest.net (67.14.62.13)  65.039 ms  62.480 ms  66.585 ms
12  63-157-106-130.dia.static.qwest.net (63.157.106.130)  63.142 ms  58.706 ms  61.740 ms
13  172.22.1.20 (172.22.1.20)  68.976 ms  59.296 ms  65.312 ms
14  192.171.21.226 (192.171.21.226)  63.501 ms  64.199 ms  64.973 ms
15  gpvpn.joann.com (208.83.32.24)  68.489 ms  63.162 ms  63.991 ms
16  i.joann.com (208.83.32.213)  71.032 ms  76.413 ms  81.920 ms
```
What's gpvpn.joann.com? Looking into it GVPN seems to stand for Global Protection VPN. I couldn't get much from its IP either but the other IPs around 208.83.32.XXX mostly seem to belong to Joann, some with some weird names.
```
👻🌵✨$ host 208.83.32.1
1.32.83.208.in-addr.arpa domain name pointer mobile.joann.com.
👻🌵✨$ host 208.83.32.2
2.32.83.208.in-addr.arpa domain name pointer globe.joann.com.
👻🌵✨$ host 208.83.32.3
3.32.83.208.in-addr.arpa domain name pointer thinclient.joann.com.
👻🌵✨$ host 208.83.32.25
25.32.83.208.in-addr.arpa domain name pointer infinitescarf.joann.com.
```
